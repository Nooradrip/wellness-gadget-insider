    ...
    <form onSubmit={handleSearch} className="w-full max-w-md">
      <div className="relative">
        <input
          ...
          className="w-full px-4 py-2 border border-gray极师
We are to provide the [query]/page.tsx with the breadcrumbs restored exactly as in the original. Here is the corrected version:
